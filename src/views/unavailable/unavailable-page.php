...
<div class="unavailable-wrapper" data-lang="<?php echo esc_attr( $lang ); ?>" data-plugin-url="<?php echo plugin_dir_url( __FILE__ ); ?>" data-api-error-title="<?php _e( 'An error occurred', 'inpost-pay' ); ?>" data-api-error-message="<?php _e( 'Error while loading', 'inpost-pay' ); ?>" data-no-results-message="<?php _e( 'No results found', 'inpost-pay' ); ?>" data-products-limit-reached="<?php echo _e( 'Hot products limit reached', 'inpost-pay' ); ?>" data-pagination-text="<?php _e( 'of', 'inpost-pay' ); ?>" data-accepted-text="<?php _e( 'Accepted', 'inpost-pay' ); ?>" data-rejected-text="<?php _e( 'Rejected', 'inpost-pay' ); ?>" data-remove-text="<?php _e( 'Remove', 'inpost-pay' ); ?>" data-highlight-period-not-selected="<?php _e( 'Not selected', 'inpost-pay' ); ?>" data-availability-set-text="<?php _e( 'Highlight period set', 'inpost-pay' ); ?>" data-api-success-title="<?php _e( 'Success', 'inpost-pay' ); ?>">
	...
	<div class="unavailable">
		...
		<div class="unavailable__search-wrapper">
			<div class="unavailable__search-input-wrapper">
				<input type="text" class="unavailable__search unavailable__search--main" placeholder="<?php _e( 'Search in the list', 'inpost-pay' ); ?>">
				<img class="unavailable__search-icon" src="<?php echo plugin_dir_url( __FILE__ ) . '../../../assets/img/hp-search.svg'; ?>" alt="">
			</div>
			<div class="unavailable__search-info">
				<div class="unavailable__sort-select">
					<select class="unavailable__sort-select-select">
						<option value="1"><?php _e( 'Sort by', 'inpost-pay' ); ?></option>
						<option value="2"><?php _e( 'Sort by', 'inpost-pay' ); ?></option>
						<option value="3"><?php _e( 'Sort by', 'inpost-pay' ); ?></option>
						<option value="4"><?php _e( 'Sort by', 'inpost-pay' ); ?></option>
						<option value="5"><?php _e( 'Sort by', 'inpost-pay' ); ?></option>
						<option value="6"><?php _e( 'Sort by', 'inpost-pay' ); ?></option>
						<option value="7"><?php _e( 'Sort by', 'inpost-pay' ); ?></option>
					</select>
				</div>
			</div>
		</div>
		...
		<div class="unavailable__pagination">
	...
	<div class="unavailable-popup-table">
		<div class="unavailable unavailable--popup">
			...
			<div class="unavailable__table-wrapper unavailable__table-wrapper--added-products unavailable__table-wrapper--hidden">
				<div class="unavailable__table-container">
					<table class="unavailable__table unavailable__table--added-products">
						<thead>
							<tr>
								<th></th>
								<th><?php _e( 'Product', 'inpost-pay' ); ?></th>
					...
					<div class="unavailable__rejected-products-info">
					...
					<table class="unavailable__table unavailable__table--rejected-products">
						<thead>
							<tr>
								<th></th>
								<th><?php _e( 'Product', 'inpost-pay' ); ?></th>
				...
				<div class="unavailable__table-actions">
					<button type="button" class="unavailable__table-actions-added-products-save-btn inpost-btn inpost-btn--primary-bg inpost-btn--large"><?php _e( 'Close', 'inpost-pay' ); ?></button>
				</div>
			</div>
		</div>
	</div>
