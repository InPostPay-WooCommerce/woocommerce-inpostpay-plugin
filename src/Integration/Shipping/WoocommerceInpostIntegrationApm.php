 ...
 * @desc iLabs
 */
class WoocommerceInpostIntegrationApm extends AbstractShippingMethodIntegration implements ParcelLockerIntegrationInterface, ShippingMethodIntegrationInterface {
