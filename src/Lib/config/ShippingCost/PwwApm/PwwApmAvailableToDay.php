<?php
/**
 * PWW APM available-to day field.
 *
...
/**
 * Class PwwApmAvailableToDay
 *
 * WordPress option storing the availability end day for PWW APM delivery.
 */
final class PwwApmAvailableToDay extends AbstractAvailabilityField implements LegacyOptionInterface, ApmMethodGroupField {

	/**
	 * Returns a new PwwApmAvailableToDay instance.
	 *
	...
	public function __construct( ?int $zone_id = null ) {
		...
		parent::__construct( 'izi_shipping_available_to_day_pww_apm', $zone_id );
	}
	...
	public function get_legacy_option_id(): string {
		return 'izi_transport_available_to_day_pww_apm';
	}
