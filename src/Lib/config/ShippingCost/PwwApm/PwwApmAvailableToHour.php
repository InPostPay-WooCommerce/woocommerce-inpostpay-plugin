<?php
/**
 * PWW APM available-to hour field.
 *
...
/**
 * Class PwwApmAvailableToHour
 *
 * WordPress option storing the availability end hour for PWW APM delivery.
 */
final class PwwApmAvailableToHour extends AbstractAvailabilityField implements LegacyOptionInterface, ApmMethodGroupField {

	/**
	 * Returns a new PwwApmAvailableToHour instance.
	 *
	...
	public function __construct( ?int $zone_id = null ) {
		...
		parent::__construct( 'izi_shipping_available_to_hour_pww_apm', $zone_id );
	}
	...
	public function get_legacy_option_id(): string {
		return 'izi_transport_available_to_hour_pww_apm';
	}
