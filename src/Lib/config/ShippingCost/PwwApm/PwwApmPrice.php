 ...
 * Class PwwApmPrice
 *
 * WordPress option storing the shipping price for PWW APM delivery.
 */
final class PwwApmPrice extends AbstractPriceField implements LegacyOptionInterface, ApmMethodGroupField {

	/**
	 * Returns a new PwwApmPrice instance.
	 *
	...
	public function __construct( ?int $zone_id = null ) {
		parent::__construct( 'izi_shipping_price_pww_apm', $zone_id );
	}
	...
	public function get_legacy_option_id(): string {
		return 'izi_transport_price_pww_apm';
	}
