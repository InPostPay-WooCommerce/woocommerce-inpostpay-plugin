<?php
/**
 * PWW APM available-from hour field.
 *
...
/**
 * Class PwwApmAvailableFromHour
 *
 * WordPress option storing the availability start hour for PWW APM delivery.
 */
final class PwwApmAvailableFromHour extends AbstractAvailabilityField implements LegacyOptionInterface, ApmMethodGroupField {
	...
	/**
	 * Returns a new PwwApmAvailableFromHour instance.
	 *
