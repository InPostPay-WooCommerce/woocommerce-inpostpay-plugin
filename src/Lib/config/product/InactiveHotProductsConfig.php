<?php
/**
 * Inactive hot products configuration.
 *
...
/**
 * Class InactiveHotProductsConfig
 *
 * WordPress option storing the list of inactive hot product IDs displayed in the InPost app.
 */
final class InactiveHotProductsConfig extends AbstractArrayOption implements InactiveHotProductsConfigInterface {
	...
	/**
	 * Returns the current list of inactive hot product IDs.
	 *
