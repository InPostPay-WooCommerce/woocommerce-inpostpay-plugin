...
use Isolated\Inpost_Pay\Isolated_Guzzlehttp\GuzzleHttp\Psr7\Exception\MalformedUriException;
use Isolated\Inpost_Pay\Isolated_Guzzlehttp\Psr\Http\Message\UriInterface;
/**
