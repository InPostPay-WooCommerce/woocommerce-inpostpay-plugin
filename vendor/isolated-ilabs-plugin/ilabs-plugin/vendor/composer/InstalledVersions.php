 ...
 */
namespace Isolated\Inpost_Pay\Composer;

use Isolated\Inpost_Pay\Composer\Autoload\ClassLoader;
use Isolated\Inpost_Pay\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Isolated\\Inpost_Pay\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
