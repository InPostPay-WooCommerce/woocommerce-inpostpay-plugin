...
use Isolated\Inpost_Pay\ZipStream\ZipStream\Option\Archive as ArchiveOptions;
...
class ZipStream
{
    ...
    protected function sendHttpHeaders() : void
    {
        ...
        $headers = array('Content-Type' => $this->opt->getContentType(), 'Content-Disposition' => $disposition, 'Pragma' => 'public', 'Cache-Control' => 'public, must-revalidate', 'Content-Transfer-Encoding' => 'binary');
