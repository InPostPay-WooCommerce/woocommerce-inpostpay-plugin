 ...
 */
namespace Isolated\Inpost_Pay\ZipStream\Composer;

use Isolated\Inpost_Pay\ZipStream\Composer\Autoload\ClassLoader;
use Isolated\Inpost_Pay\ZipStream\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Isolated\\Inpost_Pay\\ZipStream\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
